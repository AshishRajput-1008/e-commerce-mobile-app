...
const productSchema = new Schema({
  ...
  images: [String], stockUnit: { type: String, enum: ['kg', 'g', 'unit'], default: 'unit' }, price: { type: Number, required: true, min: 0 }, mrp: { type: Number, required: true, min: 0 }, stock: { type: Number, required: true, min: 0, default: 0 }, lowStockThreshold: { type: Number, min: 0, default: 5 }, unit: String, organic: { type: Boolean, default: true }, rating: { type: Number, default: 0 }, reviews: { type: Number, default: 0 }, isActive: { type: Boolean, default: true }
}, { timestamps: true });
